...
import { costEstimatorHostPanel, costEstimatorPlugin } from '@pascal-app/plugin-cost-estimator'
...
extendPluginDiscovery(async () => [treesPlugin, costEstimatorPlugin])
registerEditorHostPanel(treesHostPanel)
registerEditorHostPanel(costEstimatorHostPanel)

// (MINT AUTHENTICATION REMOVED)
